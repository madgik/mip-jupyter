...
print("Importing portal_backend_client...", flush=True)
try:
...
with patch('portal_backend_client.client.requests.Session.get') as mock_get:
...
with patch('portal_backend_client.client.requests.Session.post') as mock_post:
    mock_response = MagicMock()
